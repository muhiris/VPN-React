...
export default function Security() {
  ...
  return (
    <div className="flex-center flex-col">
      ...
      <img src={frame} style={{ height: 200, width: 200 }} />
      <div style={{ display: "flex", flexDirection: "row", marginTop: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <img src={lock} style={{ height: 100, width: 100 }} />
          <text style={{ color: "grey", marginTop: 0, marginLeft: 35 }}>
            Pin
          </text>
          <div style={{ marginLeft: 35 }} onClick={handlePin}>
            {pin ? (
              <BsToggleOn
